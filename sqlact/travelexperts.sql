...
CREATE TABLE `agents` (
  ...
  `AgtUsername` varchar(22) NOT NULL,
  `AgtPassword` varchar(22) NOT NULL
...
(424, 492, '1999-10-27 00:00:00', '1999-10-30 00:00:00', 'cruise on the Greek\'s islands', 'Greece', '650.0000', '19.5000', 425, 'MED', 'INT', 'NC', 49, 0, 0),
(425, 492, '1999-10-27 00:00:00', '1999-10-30 00:00:00', 'cruise on the Greek\'s islands', 'Greece', '650.0000', '19.5000', 425, 'MED', 'INT', 'NC', 49, 0, 0),
...
--
-- Dumping data for table `flightstable`
--
...
ALTER TABLE `bookingdetails`
  ...
  ADD CONSTRAINT `bookingdetails_ibfk_5` FOREIGN KEY (`DeparturePlnId`) REFERENCES `flightstable` (`FlightId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `bookingdetails_ibfk_6` FOREIGN KEY (`ReturnPlnId`) REFERENCES `flightstable` (`FlightId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `packages`
  ADD CONSTRAINT `packages_ibfk_1` FOREIGN KEY (`DeparturePlnId`) REFERENCES `flightstable` (`FlightId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `packages_ibfk_2` FOREIGN KEY (`ReturnPlnId`) REFERENCES `flightstable` (`FlightId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
